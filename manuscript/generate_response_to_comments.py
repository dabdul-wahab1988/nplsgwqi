...
def main() -> None:
    ...
    responses: dict[str, dict[str, str]] = {
        ...
        "C05": {"status": "Addressed", "loc": L("bayes_methods", "supp_addendum"), "resp": "Added PSIS-LOO/WAIC reporting and PPC plots for the endpoint-driver layer and referenced them in Methods/Supplementary (Table 19; Figure S10)."},
        "C06": {"status": "Partially addressed", "loc": L("bayes_methods", "supp_addendum"), "resp": "Added PSIS-LOO/WAIC and prior-scale sensitivity (Table 19–Table 20). External validation is not possible with the available data (single n=34 snapshot, no holdout set), so results are qualified accordingly."},
        ...
        "C10": {"status": "Partially addressed", "loc": L("cbe_methods", "cbe_results", "supp_addendum"), "resp": "Specified CBE thresholds (±10% primary; ±5% reported) and reported pass fractions and distribution (Table 16–Table 17; Figure 3). LOD/LOQ metadata and censoring flags were not available and are stated as a limitation."},
        ...
        "C25": {"status": "Addressed", "loc": L("bayes_methods", "supp_addendum"), "resp": "Reported Bayesian sampler diagnostics, PPC, PSIS-LOO/WAIC, and prior sensitivity summaries (Table 19–Table 20; Figure S10; Supplementary S5.2–S5.3)."},
        ...
        "C37": {"status": "Addressed", "loc": L("cbe_methods", "cbe_results"), "resp": "Provided explicit CBE thresholds, pass fractions, and distribution summary (Table 16–Table 17; Figure 3)."},
        ...
        "C41": {"status": "Partially addressed", "loc": L("bayes_methods", "supp_addendum"), "resp": "Added sampler diagnostics, PPC, PSIS-LOO/WAIC, and prior sensitivity outputs (Table 19–Table 20; Figure S10). Diagnostics are reported transparently, and weaker stability in the fluoride model is explicitly qualified in interpretation."},
